...
const photos = [
  {
    ...
    caption: "Tromsø, Norway · November 2024",
    width: 2048,
    height: 1365,
  },
  {
    ...
    caption: "Tromsø, Norway · October 2024",
    width: 2016,
    height: 1512,
  },
  {
    ...
    caption: "Svalbard, Norway · August 2024",
    width: 1600,
    height: 1066,
  },
  {
  ...
  },
  {
    ...
    caption: "Scoresbysund, Greenland · August 2024",
    width: 4032,
    height: 3024,
  },
];
        ...
        <div className="space-y-10">
          {photos.map((photo) => (
            <figure key={photo.src}>
              ...
              />
              <figcaption className="mt-2 text-sm italic text-neutral-600">
                {photo.caption}
              </figcaption>
            </figure>
          ))}
